...
# including a self-signed issuer, root CA certificate resource and cluster-wide CA issuer,
# to provide trusted TLS certificate signing capabilities for the Kubernetes cluster.
